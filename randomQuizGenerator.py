...
capitals = {'Alabama': 'Montgomery', 'Alaska': 'Juneau',
            ...
            'North Carolina': 'Raleigh', 'North Dakota':
            'Bismarck', 'Ohio': 'Columbus', 'Oklahoma': 'Oklahoma City',
            'Oregon': 'Salem', 'Pennsylvania': 'Harrisburg',
            'Rhode Island': 'Providence', 'South Carolina':
            'Columbia', 'South Dakota': 'Pierre',
...
for quizNum in range(35):
    ...
    quizFile = open('C:\\py_lessons\\automatic_by_py\\8\\project1\\quizFiles\\capitalsquiz_%s.txt' % (quizNum + 1), 'w')
    answerKeyFile = open('C:\\py_lessons\\automatic_by_py\\8\\project1\\quizFiles\\capltalsquiz_answers_%s.txt' % (quizNum + 1), 'w')
